...
In der akademischen Selbstverwaltung bin ich seit 2018 als stellv. Mitglied des Fakult&auml;tsrates der Fakult&auml;t f&uuml;r Mathematik an der OVGU Magdeburg und seit 2021 als stellv. Vorsitzender des Pr&uuml;fungsausschusses unseres Studiengangs *Mathematikingenieur* aktiv.
...
> In den Arbeiten [5,6] haben wir die nicht linearen Anteile in den Zustandsgleichungen faktorisiert, sodass die Reglerauslegung &uuml;ber sogenannte *state-dependent Riccati equations* (SDRE) m&ouml;glich war. Basierend auf dem theoretischen Ergebnis, dass eine lokal (in der Zeit) uniforme punktweise (lineare) Stabilit&auml;t hinreichend f&uuml;r globale (in der Zeit) Stabilit&auml;t ist, haben wir einen Algorithmus entwickelt der ebendas durch lineare Updates des Reglers erzielt. Im beantragten Projekt wird die verwendete Faktorisierung die Grundlage f&uuml;r die Formulierung nichtlinearer Systeme als (quasi) LPV Systeme sein. Diese Arbeiten basieren zu 90% auf meinen Beitr&auml;gen.
...
Seit 2021 bin ich gew&auml;hltes Mitglied des *MaRDI Councils*, ein Gremium, dass die Ausrichtung der im MaRDI Konsortium in Rahmen der *nationalen Forschungsdateninitiative* der DFG geleisteten and geplanten Arbeiten anhand der sogenannten *FAIR* Prinzipien evaluiert und Korrekturvorschl&auml;ge erarbeitet.
